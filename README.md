...
> **NOTE:** [feature/transaction-service](https://github.com/isnastish/kvs/tree/feature/transaction-service) branch contains the integration for TXN service using `gRPC` framework and is currently under development.